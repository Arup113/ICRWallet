...
public class TransactionsPresenter extends BasePresenter<TransactionsMvpView> {
    ...
    public void getTransactions() {
        ...
        ObjectRequest<ApiResponse> objectRequest = new ObjectRequest<>(Request.Method.POST, Endpoints.Flags.TRANSACTIONS, headers, params,
                new Response.Listener<ApiResponse>() {
                    ...
                    public void onResponse(ApiResponse response) {
                        ...
                        if (response == null) {
                            getMvpView().onTransactionsLoadedFailed();
                        } else {
                            if (response.getMessage().contains("Found")) {
                                getMvpView().onTransactionsLoadedSuccessful(response);
                            } else {
                                getMvpView().onTransactionsLoadedFailed();
                            }
                        }
